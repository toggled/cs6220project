...
df_train = pd.read_csv(dir+'train.csv', encoding="ISO-8859-1")[:1000] #update here
df_test = pd.read_csv(dir+'test.csv', encoding="ISO-8859-1")[:1000] #update here
df_pro_desc = pd.read_csv(dir+'product_descriptions.csv')[:1000] #update here
df_attr = pd.read_csv(dir+'attributes.csv')
